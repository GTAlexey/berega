...
function GraphInfoPanel({ element, hoverElement, elements, setElements, actionMode, setActionMode, kitsList = kits }: { element: any; hoverElement: any; elements: any[]; setElements: StateSetter<any[]>; actionMode: 'kits' | 'replaces' | 'replaceBy' | null; setActionMode: (mode: 'kits' | 'replaces' | 'replaceBy' | null) => void; kitsList?: any[] }) {
